...
export default function IntroAnimation({ onComplete }) {
  ...
  useEffect(() => {
    ...
    const TINTS = [
      "#C08552", "#C08552", "#C08552", "#C08552",
      "#5DADE2", "#E74C3C", "#27AE60", "#8C5A3C",
    ];
    ...
    const tick = () => {
      ...
      if (p >= 2) {
        const pulse  = p === 2 ? 0.22 + Math.sin(frame * 0.07) * 0.10 : p === 3 ? 0.45 : 0.18;
        const radius = p === 3 ? 160 : 100;
        const gr = ctx.createRadialGradient(cx, cy, 0, cx, cy, radius);
        gr.addColorStop(0, `rgba(192,133,82,${pulse})`);
        gr.addColorStop(0.5, `rgba(93,173,226,${pulse * 0.4})`);
